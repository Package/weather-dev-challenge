  ...
  return (
    <LayoutComponent title={result?.title} loading={loading}>
      <aside>
        {searchOpen && (
          <SearchComponent
            searchToggle={() => setSearchOpen(false)}
            locationSelected={locationSelected}
          />
        )}
        {!searchOpen && (
          <TodayComponent
            searchToggle={() => setSearchOpen(true)}
            location={result.title}
            forecast={result.consolidated_weather[0]}
          />
        )}
      </aside>
      ...
      <main>
        ...
        <footer>
          <p>
            created by <a href="https://github.com/Package">Package</a> -
            devChallenges.io
          </p>
        </footer>
      </main>
